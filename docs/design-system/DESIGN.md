...
> `InstrumentoSnapshotTests` (`swift test --filter InstrumentoSnapshotTests` → a local `/tmp` snapshot folder).
...
| `originBand` | `#0C8F62` | — | data-origin dot — band (= dataRecovery) (FER-708) |
