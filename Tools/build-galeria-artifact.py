...
<div class="cob">
  ...
  <div><h4 class="g">De dónde sale</h4>
    ...
    <p style="margin:0">Cada pieza se monta con el launch-arg <code>-noop.component &lt;Nombre&gt;</code> sobre <code>LiquidColor.fondoGradient</code>, con el uso de su propio <code>#Preview</code>.</p></div>
</footer>
</main>
  ...
  var D=""" )
    ...
    for p in pieces:
        detail.append({"t": p["name"], "r": p["rol"], "img": p["full"], "d": [
            ["Familia", p["fam"]], ["Archivo", p["archivo"]], ["Se monta con", f"-noop.component {p['name']}"],
