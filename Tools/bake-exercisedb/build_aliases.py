...
MOVES = [
    ...
    # — Strong / Hevy export titles (FER-328 · E8): parenthetical equipment form as the apps write it.
    # Ambiguous bare words (Row / Press / Curl / Fly) stay OUT — trap tests enforce that.
    (["Barbell Bench Press - Medium Grip", "Bench Press - Powerlifting"],
    ...
    (["Incline Dumbbell Flyes", "Incline Cable Flye"],
     ["incline chest fly", "incline chest flyes"]),
    (["Dips - Chest Version"],
    ...
    (["Lying Rear Delt Raise", "Dumbbell Lying Rear Lateral Raise"],
    ...
    (["Barbell Curl"],
     ["bicep curl (barbell)", "biceps curl (barbell)"]),
    (["Dumbbell Bicep Curl", "Seated Dumbbell Curl"],
     ["bicep curl (dumbbell)", "biceps curl (dumbbell)"]),
    (["Hammer Curls", "Cross Body Hammer Curl"],
