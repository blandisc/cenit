...
// Foundation-only CenitAnalytics package, rather than in CenitUnitTests, so it runs in the fast
...
final class CyclePhaseCopyGuardTests: XCTestCase {
    ...
    private var viewSource: String {
        get throws {
            let repoRoot = URL(fileURLWithPath: #filePath)   // …/CenitAnalyticsTests/<this file>.swift
                .deletingLastPathComponent()                  // …/CenitAnalyticsTests
                .deletingLastPathComponent()                  // …/Tests
                .deletingLastPathComponent()                  // …/CenitAnalytics
