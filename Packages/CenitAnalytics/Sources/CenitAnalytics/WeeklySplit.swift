...
// (weekday ints, a [weekday → routineId] map, counts) — never CenitTraining models or timestamps — so
// CenitAnalytics gains no dependency on CenitTraining and can never reintroduce the UTC-vs-local
