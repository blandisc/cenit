...
///
/// `Reference` is this rule's own vocabulary; the persisted domain enum (`CenitTraining.HRRestReference`)
...
public enum RestTarget {
    /// How the rest target is derived. Mirrors `CenitTraining.HRRestReference` (mapped by the consumer).
