...
/// `ProgressionMath.deloadFraction`, CenitAnalytics, que CenitTraining no puede importar), así que
/// aquí se escribe literal una sola vez, con el nombre de dónde sale.
final class ProgramDeloadTests: XCTestCase {

    /// El MISMO valor que `CenitAnalytics.ProgressionMath.deloadFraction` — una familia de «bajar».
