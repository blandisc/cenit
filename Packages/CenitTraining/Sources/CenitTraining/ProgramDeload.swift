...
//
// Vive aquí, en CenitTraining (puro, Foundation-only), y no en la pantalla, porque es una REGLA DEL
...
// CenitTraining no puede importar `PlateMath` ni `ProgressionMath` (viven en CenitAnalytics, que no
// depende de CenitTraining; ver docs/ARCHITECTURE.md), así que el redondeo a «lo que de verdad puedes
