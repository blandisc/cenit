...
// and CenitAnalytics (math). Moved out of CenitStore so analytics no longer depends on the
...
public struct DailyMetric: Equatable, Codable, Sendable {
    ...
    // ScoreConfidence lives in CenitAnalytics, above this package; conversion happens at the app layer.
...
/// CenitAnalytics (FER-372); this enum only records the raw status.
