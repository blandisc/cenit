...
// StrandAnalytics — la matemática de Cénit: preparación, esfuerzo, HRV, sueño, ciclo, tendencias.
//
...
private let vocabularios: [Target.Dependency] = ["BiometricStreams", "StrandModels"]

/// Los motores.
private let motores = Target.target(name: "StrandAnalytics",
...
private let pruebas = Target.testTarget(name: "StrandAnalyticsTests",
                                        dependencies: ["StrandAnalytics"] + vocabularios,
                                        resources: [
...
let package = Package(name: "StrandAnalytics",
                      platforms: [.iOS(.v16), .macOS(.v13)],
                      products: [.library(name: "StrandAnalytics", type: .static, targets: ["StrandAnalytics"])],
                      dependencies: [.package(path: "../BiometricStreams"), .package(path: "../StrandModels")],
