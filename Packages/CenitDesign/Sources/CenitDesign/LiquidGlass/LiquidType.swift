...
public enum LiquidType {
    ...
    /// Pie de dato / nota al pie — SF `.caption2`, escala. Sucesor de `CenitFont.footnote`
    /// para las últimas pantallas que drenó FER-306.
    public static let pie = Font.system(.caption2)
    /// Cuerpo de lista — SF `.subheadline`, escala. Sucesor de `CenitFont.body` (FER-306).
    public static let cuerpoLista = Font.system(.subheadline)
    /// Subtítulo de fila — SF `.footnote`, escala. Sucesor de `CenitFont.subhead` (FER-306).
