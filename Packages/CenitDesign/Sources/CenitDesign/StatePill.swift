...
public enum CenitTone: Sendable { // solo nombra el estado; el color lo resuelve `ficha(de:)`
    ...
    private static func ficha(de tono: CenitTone) -> Color {
        switch tono {
        case .neutral: InstrumentoTheme.base.inkSecondary
        case .accent: CenitPalette.accent
        case .positive: CenitPalette.statusPositive
        case .warning: CenitPalette.statusWarning
        case .critical: CenitPalette.statusCritical
        }
    }
}
