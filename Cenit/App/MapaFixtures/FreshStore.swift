...
/// `-noop.freshStore YES` (FER-381): borra la base SQLite ANTES de que el store se abra, para que
...
enum FreshStore {
    static func applyIfRequested() {
        ...
        guard UserDefaults.standard.string(forKey: "noop.freshStore")?.lowercased() == "yes" else { return }
