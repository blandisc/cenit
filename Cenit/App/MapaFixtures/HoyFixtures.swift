...
///
/// `ScreenshotFixtures.activeState()` filtra `-noop.fixture` contra una lista blanca LITERAL
...
/// `"fixture":"leyendo"` en `hoy.json` pasaría `-noop.fixture leyendo`, `activeState()` no lo
...
/// `TodayView.swift` (`-noop.healthDenied`, `-noop.hour`, `-noop.syncStale`) y con `DebugRoute` para
