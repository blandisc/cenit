...
struct TrainingBodyScreen: View {
    ...
    /// The mini load indicator for the peeked muscle — a tap target into the full detail. Fila
    /// pelona con filete `tinta10` (FER-295 · Parte 5): sin `EntrenarModulo` anidado dentro del
    /// módulo de figuras.
