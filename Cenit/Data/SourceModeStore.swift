...
/// The data-source mode. Historically a user preference (combined / legacy-only / Apple-Health-only)
...
final class SourceModeStore: ObservableObject {
    ...
    /// ola de superficies). La partición del dispositivo anterior queda DORMIDA en la DB, excluida
